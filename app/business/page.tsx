...
export default function Home() {
  ...
  axios.post('https://staff-management-system-ews1.onrender.com/business/post', { name: name, location:location, type:type } , {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}})
    .then(res => {
      if (res.data) {
