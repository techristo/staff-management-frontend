...
export default function Home() {
  ...
  axios.put('https://staff-management-system-ews1.onrender.com/staffmember/put/'+oldID, { fname: fname, lname:lname, email:email, position:position, btype:btype, phone:phone  } , {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}})
    .then(res => {
      if (res.data) {
...
<div className="container mt-5">
  <div className="row">
    ...
    <input type="text" className="form-control" id="uname" placeholder="Enter old id" name="oldID" value={oldID}  onChange={(e) => setOldID(e.target.value)} required/>
  </div>
    <div className="mb-3">
